...
gsap
  ...
  .from("#scene-apple-falling .phone-container", {
    x: window.innerWidth,
    duration: 500,
  })
  .to("#scene-apple-falling .phone-container", {
    duration: 6000,
    scrollTrigger: {
      trigger: "#batta-video",
      start: "center center",
  ...
  .to(
    "#scene-apple-falling .spb-2",
    { display: "inline-block", opacity: 1 },
    ">"
  )
  .to("#scene-apple-falling .spb-2", {
    display: "none",
    opacity: 0,
    delay: 500,
  })
  ...
  .to(
    "#scene-apple-falling .apple-phone",
    { y: -window.innerHeight, duration: 500 },
    "<"
  );
...
gsap
  ...
  .from(
    "#scene-tree-banana .tree",
    { y: -window.innerHeight / 2, duration: 500 },
    "<"
  )
  .to("#scene-tree-banana .banana", { display: "block" })
  .from(
    "#scene-tree-banana .banana",
    { y: -window.innerHeight / 2, duration: 500 },
    "<"
  )
